...
* **THE LILA BAN:** The "AI Neon Glow" aesthetic is strictly BANNED — no purple/blue button glows, no neon gradients. A flat, solid accent color (including blue) is NOT banned; the glow/gradient effect is the problem, not the hue. Use absolute neutral bases (Zinc/Slate) with high-contrast, singular accents (e.g. Emerald, Electric Blue, or Deep Rose).
